...
from src.model.encoder.splatweaver import EncoderSplatWeaver, EncoderSplatWeaverCfg, OpacityMappingCfg

class SplatWeaver(nn.Module, huggingface_hub.PyTorchModelHubMixin):
    def __init__(
        self,
        encoder_cfg: EncoderSplatWeaverCfg,
        decoder_cfg: DecoderSplattingCUDACfg,
    ):  
        super(SplatWeaver, self).__init__()
    ...
    def convert_encoder_config(self, encoder_cfg: EncoderSplatWeaverCfg) -> EncoderSplatWeaverCfg:
    ...
    def inference(self,
        ...
        gaussians, pred_context_pose, expert_selection = encoder_output.gaussians, encoder_output.pred_context_pose, encoder_output.choice[0]
        return gaussians, pred_context_pose, expert_selection
