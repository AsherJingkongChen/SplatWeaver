...
from .dataset_general import DatasetGeneral, DatasetGeneralCfgWrapper
from .dataset_re10k import DatasetRe10k, DatasetRe10kCfgWrapper
from .dataset_arkit import DatasetArkit, DatasetArkitCfgWrapper
...
DatasetCfgWrapper = DatasetDL3DVCfgWrapper | DatasetScannetppCfgWrapper | DatasetCo3dCfgWrapper | DatasetGeneralCfgWrapper | DatasetArkitCfgWrapper | DatasetRe10kCfgWrapper
